...
class UserController extends Controller
{
     ...
     *    404="User not found"
     *  },
     *  output="Zorbus\ApiBundle\Entity\User"
     * )
     */
    public function getAction($username)
    {
        ...
        $userManager = $this->get('Zorbus.api.manager.user');
     ...
     * @Method({"POST"})
     * @View(statusCode=201)
     * @BadRequest("Zorbus\ApiBundle\Type\User\UserCreateType")
     * @ApiDoc(
     *  section="Users",
     *  resource=true,
     ...
     *    400="Bad request"
     *  },
     *  input="Zorbus\ApiBundle\Type\User\UserCreateType",
     *  output="Zorbus\ApiBundle\Entity\User"
     * )
     */
    public function createAction(UserCreateRequest $userCreateRequest)
    {
        ...
        $userEntityRepository = $this->get('Zorbus.api.entity.repository.user');
